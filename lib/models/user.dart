class Resp {
  ...
  Resp(
      this.componente,
      this.percentualLancamentoFrequencia,
      this.percentualLancamentoNotas,
      this.qtdAlunos,
      this.id,
      this.professor,
      this.sala,
  ...
  Resp.fromJson(Map<String, dynamic> json) {
    ...
    percentualLancamentoFrequencia =
        int.parse(json["get_percentual_lancamento_frequencia"]);
    percentualLancamentoNotas =
        int.parse(json["get_percentual_lancamento_notas"]);
